          ...
          <form className="p-6 md:p-8" onSubmit={handleLogin}>
            <div className="flex flex-col gap-6">
              ...
              <div className="grid grid-cols-3 gap-4">
                {/* Botões de provedores externos (Apple, Google, Meta) - Mantenha se for usar */}
              ...
              <div className="text-center text-sm">
                Não tem uma conta?{" "}
                <a onClick={props.onSwitchToRegister} className="underline underline-offset-4 cursor-pointer">
                  Registre-se
                </a>
              </div>
            </div>
