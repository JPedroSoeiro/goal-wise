...
import { AdcJogador } from "./_components/adc-time";
...
export default function TeamsPage() {
  ...
  // Função para buscar teams da API
  ...
  useEffect(() => {
    fetchTeams(); // Chama a API assim que o componente é montado
  }, []);

  // Callback para AdcJogador adicionar um novo team à lista
  const handleTeamAdded = (newTeam: Teams) => {
    setTeams((prev) => [...prev, newTeam]);
    fetchTeams(); // Opcional: refetch para garantir dados atualizados (ex: se o backend adicionar um ID)
  };
